    ...
    <form id="form1" runat="server">
        <div class="wrapper">
            <div class="wrapper__welcome">
                <asp:Image ID="Image1" runat="server" class="wrapper__image" ImageUrl="https://picsum.photos/200/300" />
            ...
            <asp:Label ID="Label3" runat="server" Text="Mensaje "></asp:Label>
                ...
                <div class="wrapper__buttons">
                    ...
                    <asp:Button ID="btn_MarcarSalida" runat="server" Text="Marcar Salida" />
